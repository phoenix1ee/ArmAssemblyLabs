#
# Program name: agequote.s

# Author: Shun Fai Lee
# Date: 2/15/2025
# Purpose: This program is to use scanf to get use input of their age as integer and print input by user with quote
# Input:
#   - input: User entered number
# Output:
#   - format: prints the number
# Remarks: for assignment4 Q3
#
